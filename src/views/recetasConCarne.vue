      ...
      <div v-if="selectedRecipe" class="modal-overlay" @click="closeModal">
        <div class="modal-content" @click.stop>
          ...
          <div v-else>
            ...
            <h3>Publicado por:</h3>
            <p>
              <strong>{{ selectedRecipe.user.name }}</strong>
            ...
            <h3>Pasos:</h3>
            <ol>
              <li v-for="(step, index) in selectedRecipe.steps" :key="index">{{ step }}</li>
            </ol>
          </div>
  ...
  import Usuariologo2 from "../views/img/imgsodio/usuario2.png";
    ...
    export default {
          ...
          recipes: [
            {
              ...
              ingredients: ['200g de mozzarella fresca', '4 tomates maduros', 'Hojas de albahaca fresca', 'Aceite de oliva extra virgen', 'Vinagre balsámico (opcional)', 'Pimienta negra recién molida'],
              steps: ['Cortar la mozzarella y los tomates en rodajas.', 'Alternar las rodajas de mozzarella y tomate en un plato.', 'Añadir hojas de albahaca entre las rodajas.', 'Rociar con aceite de oliva y vinagre balsámico si se desea.', 'Sazonar con pimienta negra al gusto.'],
            ...
            },
            {
              ...
              image: Bebidarosa,
              ingredients: ['2 1/2 libras de sandía sin semillas', '1/4 de taza de jugo de lima fresco', '1 taza de jugo de arándanos rojos', '1 lima cortada en rodajas'],
              steps: ['Licúa la sandía hasta obtener una consistencia suave.', 'Pasa el puré por un tamiz fino para eliminar la pulpa.', 'Añade jugos de arándano y lima y refrigera hasta enfriar.', 'Sirve con rodajas de lima.'],
            ...
            },
            {
              ...
              image: PandeBana,
              ingredients: ['1/2 taza de harina de arroz integral', '1/2 taza de harina de amaranto', '1/2 taza de harina de tapioca', '1/2 de taza de harina de mijo', '1/2 taza de harina de quinua', '1 cucharadita de bicarbonato de sodio', '2 tazas de puré de banana'],
              steps: ['Precalentar el horno a 350°F.', 'Mezclar los ingredientes secos.', 'Añadir los húmedos y mezclar bien.', 'Hornear durante 50-60 minutos.'],
      ...
      methods: {
        ...
        addComment() {
          if (this.newComment.trim() !== '' && this.selectedRecipe) {
